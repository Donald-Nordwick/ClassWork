...
public class Lab5 {
	public static void main(String[] args) {
		...
		System.out.println("Hello, we are going to play guess odd or even. In order to start please choose your lower limit:");
		low = input.nextInt();
		System.out.println("Please choose the upper limit of your numbers:");
		high=input.nextInt();
		while (i < 10) {

			
			RetrieveANumber ranNum = new RetrieveANumber();
			dieRoll= ranNum.GetANumber(low,high);
			compNum[i] = dieRoll;
			gameNum = dieRoll%2;
			...
			System.out.println("Guess if the number is odd or even. Use 1 for odd and 0 for even.");
